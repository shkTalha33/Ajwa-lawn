<section>
  <div class="flex flex-wrap divide-x divide-gray-200">
      ...
      <div class="flex flex-col justify-center px-4 text-center h-full">
        <div class="max-w-xl mx-auto">
          ...
          <p class="mb-20 text-gray-400">
            Really nicely designed theme and quite fast loading. The quickness
            of page loads you can really appreciate once for you turn off page
            of the transition preloader in theme options. Custom of a support
            was really quick.
          </p>
    ...
    <div class="w-full lg:max-w-md px-12 pt-16 pb-32">
      <div class="">
        <h3 class="mb-24 font-heading text-3xl text-gray-900">
          Your Order Summary
        </h3>
        <span class="mb-4 inline-block text-xl font-semibold text-neutral-900">
          1 Item
        </span>
        <div class="flex flex-wrap justify-between -m-2">
          ...
          <div class="w-auto p-2">
            <span class="font-semibold text-green-900">£258</span>
          </div>
        </div>
        <div class="flex flex-wrap justify-between -m-2">
          <div class="w-auto p-2">
        ...
        <div class="flex flex-wrap justify-between -m-2 mb-7">
          <div class="w-auto p-2">
            <span class="text-gray-400">Cash on Delivery Charge</span>
          </div>
          <div class="w-auto p-2">
            <span class="font-semibold text-green-900">£5</span>
          </div>
        </div>
        <div class="flex flex-wrap justify-between -m-2">
          <div class="w-auto p-2">
        ...
        <span class="mb-12 inline-block text-xs text-gray-400 font-semibold">
          All tax included
        </span>
        ...
        <p class="text-gray-400">info@afgmaterassi.org</p>
        <p class="text-gray-400">+39-22-082852282</p>
      </div>
    </div>
  </div>
</section>;
